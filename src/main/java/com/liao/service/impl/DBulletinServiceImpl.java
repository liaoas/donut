...
public class DBulletinServiceImpl implements DBulletinService {
    ...
    /**
     * set注入
     * @param dBulletinMapper
     */
    @Autowired
    public void setdBulletinMapper(DBulletinMapper dBulletinMapper){
        this.dBulletinMapper = dBulletinMapper;
    }
     ...
     */
    @Override
    @ServiceLog(description = "公告分页查询")
    public Rejson bulletinDynamicSelect(DBulletin record, Integer pn,String stectTime) {
        Rejson rejson = new Rejson();
        PageHelper.startPage(pn, 5);
        PageInfo pageInfo = new PageInfo(dBulletinMapper.bulletinDynamicSelect(record,stectTime));
